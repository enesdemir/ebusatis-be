...
export class AccountingService {
  constructor(
    @InjectRepository(StockValuation) private readonly valuationRepo: EntityRepository<StockValuation>,
    @InjectRepository(ExchangeGainLoss) private readonly fxRepo: EntityRepository<ExchangeGainLoss>,
    @InjectRepository(TaxReport) private readonly taxRepo: EntityRepository<TaxReport>,
