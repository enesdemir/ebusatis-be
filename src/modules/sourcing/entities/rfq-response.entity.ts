...
export class RFQResponse extends BaseTenantEntity {
  ...
  @Property({ type: 'decimal', precision: 10, scale: 2, default: 0 }) totalPrice: number = 0;
  ...
  @Property({ type: 'json', nullable: true }) lineItems?: Array<{ variantId: string; unitPrice: number; moq?: number; note?: string }>;
