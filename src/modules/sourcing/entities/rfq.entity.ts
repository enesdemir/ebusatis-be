...
export enum RFQStatus { DRAFT = 'DRAFT', SENT = 'SENT', RECEIVED = 'RECEIVED', EVALUATED = 'EVALUATED', CLOSED = 'CLOSED', CANCELLED = 'CANCELLED' }
...
export class RFQ extends BaseTenantEntity {
  ...
  @Property({ type: 'json', nullable: true }) items?: Array<{ variantId: string; quantity: number; note?: string }>;
