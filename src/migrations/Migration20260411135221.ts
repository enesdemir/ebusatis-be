...
export class Migration20260411135221 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create index "idx_notification_tenant_date" on "notifications" ("tenant_id", "created_at");`);
    this.addSql(`create index "idx_notification_recipient_read" on "notifications" ("recipient_id", "is_read");`);

    this.addSql(`alter table "tax_reports" add constraint "tax_reports_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);

    this.addSql(`alter table "sales_channels" add constraint "sales_channels_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);

    this.addSql(`alter table "exchange_gain_losses" add constraint "exchange_gain_losses_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);

    this.addSql(`alter table "channel_orders" add constraint "channel_orders_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    this.addSql(`alter table "channel_orders" add constraint "channel_orders_channel_id_foreign" foreign key ("channel_id") references "sales_channels" ("id") on update cascade;`);

    this.addSql(`alter table "stock_valuations" add constraint "stock_valuations_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    this.addSql(`alter table "stock_valuations" add constraint "stock_valuations_product_id_foreign" foreign key ("product_id") references "products" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "channel_product_mappings" add constraint "channel_product_mappings_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    this.addSql(`alter table "channel_product_mappings" add constraint "channel_product_mappings_channel_id_foreign" foreign key ("channel_id") references "sales_channels" ("id") on update cascade;`);
    this.addSql(`alter table "channel_product_mappings" add constraint "channel_product_mappings_variant_id_foreign" foreign key ("variant_id") references "product_variants" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "freight_quotes" add constraint "freight_quotes_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "customs_declarations" add constraint "customs_declarations_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "container_events" add constraint "container_events_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "rfqs" add constraint "rfqs_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    this.addSql(`alter table "rfqs" add constraint "rfqs_created_by_id_foreign" foreign key ("created_by_id") references "users" ("id") on update cascade;`);

    this.addSql(`alter table "rfq_responses" add constraint "rfq_responses_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    this.addSql(`alter table "rfq_responses" add constraint "rfq_responses_rfq_id_foreign" foreign key ("rfq_id") references "rfqs" ("id") on update cascade;`);

    this.addSql(`alter table "notifications" add constraint "notifications_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table "channel_orders" drop constraint "channel_orders_channel_id_foreign";`);

    this.addSql(`alter table "channel_product_mappings" drop constraint "channel_product_mappings_channel_id_foreign";`);
    ...
    this.addSql(`alter table "rfq_responses" drop constraint "rfq_responses_rfq_id_foreign";`);
