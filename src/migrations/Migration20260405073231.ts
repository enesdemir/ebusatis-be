...
export class Migration20260405073231 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "attributes" add constraint "attributes_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "product_variant_attribute_values" add constraint "product_variant_attribute_values_variant_id_foreign" foreign key ("variant_id") references "product_variants" ("id") on update cascade;`);
    this.addSql(`alter table "product_variant_attribute_values" add constraint "product_variant_attribute_values_attribute_id_foreign" foreign key ("attribute_id") references "attributes" ("id") on update cascade;`);
    ...
    this.addSql(`alter table "product_attribute_values" add constraint "product_attribute_values_product_id_foreign" foreign key ("product_id") references "products" ("id") on update cascade;`);
    this.addSql(`alter table "product_attribute_values" add constraint "product_attribute_values_attribute_id_foreign" foreign key ("attribute_id") references "attributes" ("id") on update cascade;`);
