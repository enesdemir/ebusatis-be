...
export class Migration20260408151932 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `alter table "quality_checks" add constraint "quality_checks_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "quality_checks" add constraint "quality_checks_inspector_id_foreign" foreign key ("inspector_id") references "users" ("id") on update cascade on delete set null;`,
    );

    this.addSql(
      `alter table "production_milestones" add constraint "production_milestones_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`,
    );
    this.addSql(
    ...
    this.addSql(
      `alter table "production_milestones" add constraint "production_milestones_assigned_to_id_foreign" foreign key ("assigned_to_id") references "users" ("id") on update cascade on delete set null;`,
    );

    this.addSql(
      `alter table "production_media" add constraint "production_media_tenant_id_foreign" foreign key ("tenant_id") references "tenants" ("id") on update cascade;`,
    );
    this.addSql(
