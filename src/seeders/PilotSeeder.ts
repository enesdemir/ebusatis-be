...
import {
  Warehouse,
  WarehouseType,
} from '../modules/definitions/entities/warehouse.entity';
...
import {
  ShipmentLeg,
  ShipmentLegType,
} from '../modules/logistics/entities/shipment-leg.entity';
import {
...
import {
  ContainerEvent,
  ContainerEventType,
} from '../modules/logistics/entities/container-event.entity';
import {
  CustomsDeclaration,
  CustomsStatus,
} from '../modules/logistics/entities/customs-declaration.entity';
import {
  GoodsReceive,
  GoodsReceiveStatus,
} from '../modules/inventory/entities/goods-receive.entity';
import {
  GoodsReceiveLine,
  DiscrepancyType,
...
export class PilotSeeder extends Seeder {
  async run(em: EntityManager): Promise<void> {
    ...
    const adminUser = await em.findOneOrFail(
      User,
    ...
    const supplier = em.create(Partner, {
      tenant,
      name: 'Shanghai Silk Factory Co.',
      code: 'SSF-001',
      types: [PartnerType.SUPPLIER],
      supplierSubtype: SupplierSubtype.FABRIC_FACTORY,
    ...
    const po = em.create(PurchaseOrder, {
      ...
      paymentTerms: '30% deposit, 70% on B/L',
    ...
    const spo = em.create(SupplierProductionOrder, {
      tenant,
      productionNumber: 'SPO-2026-PILOT-001',
      purchaseOrder: po,
      supplier,
      product,
      variant,
    ...
    const milestoneData = [
      {
        ...
        name: 'milestones.dyehouse',
        status: MilestoneStatus.COMPLETED,
        sortOrder: 0,
      },
      {
        code: StandardMilestoneCode.WEAVING,
        name: 'milestones.weaving',
        status: MilestoneStatus.COMPLETED,
        sortOrder: 1,
      },
      {
        code: StandardMilestoneCode.FINISHING,
        name: 'milestones.finishing',
        status: MilestoneStatus.COMPLETED,
        sortOrder: 2,
      },
      {
        code: StandardMilestoneCode.QC,
        name: 'milestones.qc',
        status: MilestoneStatus.COMPLETED,
        sortOrder: 3,
      },
      {
        ...
        name: 'milestones.packaging',
        status: MilestoneStatus.COMPLETED,
        sortOrder: 4,
      },
      {
        code: StandardMilestoneCode.READY_FOR_PICKUP,
        name: 'milestones.ready_for_pickup',
    ...
    const shipment = em.create(Shipment, {
      tenant,
      shipmentNumber: 'SH-2026-PILOT-001',
    ...
    const leg1 = em.create(ShipmentLeg, {
      ...
      originLocation: 'Shanghai Silk Factory',
      destinationLocation: 'Shanghai Port',
      estimatedDeparture: new Date('2026-04-15'),
      estimatedArrival: new Date('2026-04-15'),
      actualDeparture: new Date('2026-04-15'),
      actualArrival: new Date('2026-04-15'),
      freightCost: 500,
      storageCost: 0,
      otherCosts: 0,
      currency: usdCurrency,
    ...
    const leg2 = em.create(ShipmentLeg, {
      ...
      originLocation: 'Shanghai Port',
      destinationLocation: 'Istanbul Ambarli Port',
      estimatedDeparture: new Date('2026-04-16'),
      estimatedArrival: new Date('2026-05-13'),
      actualDeparture: new Date('2026-04-16'),
      actualArrival: new Date('2026-05-12'),
      freightCost: 8000,
      storageCost: 200,
      otherCosts: 0,
      currency: usdCurrency,
    ...
    const leg3 = em.create(ShipmentLeg, {
      ...
      originLocation: 'Istanbul Ambarli Port',
      destinationLocation: 'Main Warehouse, Istanbul',
      intermediateWarehouse: mainWarehouse,
      estimatedDeparture: new Date('2026-05-14'),
      estimatedArrival: new Date('2026-05-14'),
      actualDeparture: new Date('2026-05-14'),
      actualArrival: new Date('2026-05-14'),
      freightCost: 1500,
      storageCost: 0,
      otherCosts: 0,
    ...
    const events = [
      {
        type: ContainerEventType.LOADED_AT_FACTORY,
        date: '2026-04-15',
        location: 'Shanghai',
      },
      {
        type: ContainerEventType.AT_ORIGIN_PORT,
        date: '2026-04-15',
        location: 'Shanghai Port',
      },
      {
        type: ContainerEventType.LOADED_ON_VESSEL,
        date: '2026-04-16',
        location: 'Shanghai Port',
      },
      {
        type: ContainerEventType.AT_DESTINATION_PORT,
        date: '2026-05-12',
        location: 'Istanbul Ambarli',
      },
      {
        type: ContainerEventType.DELIVERED,
        date: '2026-05-14',
    ...
    em.persist(
      em.create(CustomsDeclaration, {
        tenant,
        declarationNumber: 'GTD-2026-PILOT-001',
        shipment,
        status: CustomsStatus.APPROVED,
    ...
    const gr = em.create(GoodsReceive, {
      tenant,
      receiveNumber: 'GR-2026-PILOT-001',
      supplier,
    ...
    const claim = em.create(SupplierClaim, {
      tenant,
      claimNumber: 'CLM-2026-PILOT-001',
      supplier,
      goodsReceive: gr,
      purchaseOrder: po,
      ...
      currency: usdCurrency,
      description:
        '5 rolls of PRM-VLV-EMR arrived with water damage from a container leak during the Shanghai→Istanbul sea leg.',
    ...
    em.persist(
      em.create(SupplierClaimLine, {
        tenant,
        claim,
        goodsReceiveLine: grLine2,
        variant,
        affectedQuantity: 5,
        unitPrice: 500,
        lineTotal: 2500,
    ...
    em.persist(
      em.create(LandedCostCalculation, {
        tenant,
        purchaseOrder: po,
        shipment,
        productCost: 50000,
    ...
    console.log(
      '  ✓ Customs: GTD-2026-PILOT-001 (duty 5,000 + VAT 9,000 + broker 500 + ins 300)',
    );
